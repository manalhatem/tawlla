...
class ElementNotification extends StatelessWidget {
  const ElementNotification({Key? key}) : super(key: key);
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Icon(Icons.notifications, color: AppColor.purpleColor,),
              ],
            ),
            SizedBox(height: height(context)*0.01,),
            CustomText(text: 'وافق مطعم ديري كوين على طلب الحجز الخاص بك رقم 15537', color: AppColor.blackColor,align: TextAlign.end,)
          ],
        ),
      ),
    );
